...
HD_PWD='C:/Users/squid/OneDrive/Documents/Vivado/2023/SlowClocks/SlowClocks.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Clock1kHz_s.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Clock1kHz_s.tcl
